Public Class idiomas
    ...
    Private Sub idiomas_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
    ...
    Private Sub idiomas_Move(sender As Object, e As EventArgs) Handles Me.Move
    ...
    Private Sub carga_grill()
        ...
        myset = objetocargas.charge_data_set_Byreference("idiomas")
