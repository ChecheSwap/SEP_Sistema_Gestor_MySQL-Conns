Public Class explaboral
    ...
    Private Sub explaboral_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        menudocentesistema.Show()
    End Sub

    Private Sub explaboral_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub explaboral_Move(sender As Object, e As EventArgs) Handles Me.Move
    ...
    Private Sub carga_grill()
        ...
        myset = objetocargas.charge_data_set_Byreference("exp_lab")
